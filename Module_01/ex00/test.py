...
"mustard"], "Take three tomatoes and cut them vertically in slices. Take a
bowl. Put two spoons of oil and one spoon of vinegar. Add a little bit of
mustard. Pour the sauce on your tomatoes. Enjoy your tomatoes salad",
"starter")
...
porridge_failed3 = Recipe("porridge", 2, 5, ["oat", "milk", "honey",
"hazelnuts"], "Put the desired amount of oat in a bowl. Pour the milk
above. Put in the microwave for 1.30 minutes. Add some honey and
...
porridge_failed1 = Recipe("porridge", "a", 5, ["oat", "milk", "honey",
"hazelnuts"],"Put the desired amount of oat in a bowl. Pour the milk
above. Put in the microwave for 1.30 minutes. Add some honey and
hazenuts. Your porridge is now ready to be eaten.", "dessert")
